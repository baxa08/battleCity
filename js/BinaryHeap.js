 ...
 * Binary Heap
 *
 * Данный код представляет собой реализацию двоичной кучи (Binary Heap) в JavaScript.
 *  Он предоставляет функциональность для добавления элемента в кучу, извлечения первого элемента из кучи, 
 * удаления заданного элемента из кучи и определения количества элементов в куче.
