//StageStart используется для отображения начала нового уровня игры.
function StageStart()
{
		this.time = -15;
		this.frame = 0;
...
//Метод draw отрисовывает начало уровня на холсте, используя графические ресурсы и анимацию.
...
//Метод init инициализирует значения свойств объекта для нового уровня.
