/**Этот файл содержит определение конструктора Sprite, который представляет объект "Спрайт",
 *  а также метод hitTestObject, который выполняет проверку на столкновение спрайта с другим объектом.  */
