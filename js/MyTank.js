//MyTank - конструктор объекта "Мой танк". Он наследует свойства и методы от базового класса Tank и устанавливает начальные значения свойств для "Моего танка".
function MyTank(x, y)
{
...
//MyTank.prototype.draw - метод, отвечающий за отрисовку танка на холсте.
...
//MyTank.prototype.shot - метод, выполняющий выстрел.
...
//MyTank.prototype.update - метод, обновляющий состояние танка.
...
//Tank1, Tank2, Tank3 - конструкторы объектов разных типов танков.
...
//Tank3.prototype.draw - переопределенный метод для отрисовки танка "Танк3".
